...
######################################################################
#result = scipy.io.loadmat('../deep-person-reid/log/resnet50-xent-htri-ibn-market1501-h384/dp_result_single_f.mat')
def rerank_main(query_f,query_cam,query_label,gallery_f,gallery_cam,gallery_label):
