...
class AttentionModule_pre(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1, size2, size3):
        ...
        self.interpolation3 = nn.Upsample(size=size3,mode='bilinear',align_corners=True)

        self.softmax4_blocks = ResidualBlock(in_channels, out_channels)

        self.interpolation2 = nn.Upsample(size=size2,mode='bilinear',align_corners=True)

        self.softmax5_blocks = ResidualBlock(in_channels, out_channels)

        self.interpolation1 = nn.Upsample(size=size1,mode='bilinear',align_corners=True)
...
class AttentionModule_stage1(nn.Module):
    # input size is 56*56
    def __init__(self, in_channels, out_channels, size1=(64, 32), size2=(32, 16), size3=(16, 8)):
...
class AttentionModule_stage2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(32, 16), size2=(16, 8)):
...
class AttentionModule_stage3(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(16, 8)):
